...
const emailFYSAService = container.get(email_fysa_service_1.EmailFYSAService);
emailFYSAService.processFYSAInput(fysaInputGoogle, 'katie@foresightreports.com', true).then((results) => {
    console.log(JSON.stringify(results, null, 2));
});
//# sourceMappingURL=test-fysa.js.map