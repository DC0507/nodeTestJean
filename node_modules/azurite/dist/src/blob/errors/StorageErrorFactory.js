...
class StorageErrorFactory {
    ...
    static getInvalidPageRange2(contextID) {
        return new StorageError_1.default(416, "InvalidRange", "The range specified is invalid for the current size of the resource.", contextID);
    }
